    ...
    <div class="row">
        <div class="col-md-12">
            <div class="title_left">
                <h3>Gestión Detalle de Servicios</h3>
            </div>
            <br>
        </div>
    </div>
    ...
    <div class="" id="administradorDetalle">
        <div class="x_panel">
            <div class="x_title">
                ...
                <h4><i class="fa fa-bars"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Administrador de  Detalle de Servicios </font></font></h4>
                
               
            </div>
            <div class="x_content x_content_border_mobil">

                    <form id="frm_Detalle" method="POST" action="{{url('gestionServicios/detalle')}}"  enctype="multipart/form-data"  class="formulario form-horizontal form-label-left">
                        {{csrf_field() }}
                        <input id="method_Detalle" type="hidden" name="_method" value="POST">
                        
                        @if(session()->has('mensajePInfoDetalleServicio'))
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="alert alert-{{session('estadoP')}} alert-dismissible fade in" role="alert" style="margin-bottom: 0;">
                                        ...
                                        <strong>Información: </strong> {{session('mensajePInfoDetalleServicio')}}
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="descripcion_parroquia">Detalle <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="detalle" name="detalle" placeholder="Descripción" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
